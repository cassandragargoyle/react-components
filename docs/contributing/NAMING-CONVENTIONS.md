...
This document defines naming conventions used throughout the react-components project to ensure consistency and readability across all code, documentation, and resources.
...
package com.organization.reactcomponents.service;
...
- **Prefix with project**: `REACT_COMPONENTS_DATABASE_URL`
- **Common patterns**:
  - `REACT_COMPONENTS_PORT`
  - `REACT_COMPONENTS_LOG_LEVEL`
  - `REACT_COMPONENTS_API_KEY`
...
- **Pattern**: `REACT_COMPONENTS_ERROR_{CATEGORY}_{SPECIFIC}`
- **Examples**:
  - `REACT_COMPONENTS_ERROR_AUTH_INVALID_TOKEN`
  - `REACT_COMPONENTS_ERROR_DB_CONNECTION_FAILED`
...
- **Examples**:
  ...
  - `[INFO] DatabaseManager: Connection established (host: localhost, db: react-components)`

## Project-Specific Conventions

### react-components Specific Terms
...
*These conventions should be followed for all new code in react-components. For questions or suggestions, refer to the [Terminology Guide](TERMINOLOGY.md) or discuss with the team.*
