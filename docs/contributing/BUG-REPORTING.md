...
This guide helps you report bugs effectively to ensure quick resolution and improve react-components.

## Before Reporting

### 1. Search Existing Issues

- Check [existing issues](https://github.com/cassandragargoyle/react-components/issues) first
...
- **React Components Version**: [Version number]
...
echo "Version: $(react-components --version)"
echo "OS: $(uname -a)"
echo "Date: $(date)"
echo "Logs (last 50 lines):"
tail -50 /var/log/react-components/error.log
```
